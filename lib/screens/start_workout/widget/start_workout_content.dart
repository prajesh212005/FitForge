...
class StartWorkoutContent extends StatelessWidget {
            ...
            return Row(
              children: [
                Container(
                  width: 40,
                  height: 40,
                  decoration: BoxDecoration(color: ColorConstants.surface, borderRadius: BorderRadius.circular(14), border: Border.all(color: ColorConstants.surfaceBorder)),
                  child: const Icon(Icons.arrow_back_rounded, color: ColorConstants.whiteOnDark),
                ),
                const SizedBox(width: 12),
                Text(
                  TextConstants.back,
                  style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: ColorConstants.whiteOnDark),
                ),
              ],
            );
          },
  ...
  Widget _createVideo(BuildContext context) {
    ...
    return Container(
      height: 264,
      width: double.infinity,
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(26), color: ColorConstants.surface, border: Border.all(color: ColorConstants.surfaceBorder)),
  ...
  Widget _createTitle() {
    return Text(exercise.title, style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w800, color: ColorConstants.whiteOnDark));
  }

  Widget _createDescription() {
    return Text(exercise.description, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: ColorConstants.textGrey));
  }
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: ColorConstants.primaryColor.withOpacity(0.16),
          ),
          child: Center(child: Text(number, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: ColorConstants.whiteOnDark))),
        ),
        const SizedBox(width: 10),
        Expanded(child: Text(description, style: const TextStyle(color: ColorConstants.textGrey))),
      ],
    );
  }
}
